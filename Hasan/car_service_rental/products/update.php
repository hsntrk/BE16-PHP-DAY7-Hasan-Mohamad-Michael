    ...
    <fieldset>
        ...
        <form action="actions/a_update.php" method="post" enctype="multipart/form-data">
            <table class="table">
                <tr>
                    <th>Name</th>
                    <td><input class="form-control" type="text" name="name" placeholder="Car Model" value="<?php echo $name ?>" /></td>
                </tr>
                <tr>
                    <th>Retal Price / day</th>
                    <td><input class="form-control" type="number" name="rental_price" step="any" placeholder="Rental Price" value="<?php echo $rental_price ?>" /></td>
                </tr>
                <tr>
                    <th>Status</th>
